...
export function KpiCard({ label, value, hint, accentClassName, backgroundChart }: KpiCardProps) {
  return (
    <article className="relative overflow-hidden rounded-xl border bg-card p-4">
